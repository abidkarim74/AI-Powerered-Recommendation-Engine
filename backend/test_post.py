...
async def main():
    SYSTEM_PROMPT = """
You are a recommendation engine. You analyze user preferences and return recommendations.
...
"""
    ...
    Return exactly {n} recommendations in the specified JSON schema.
    """.format(
        preferences="likes action movies, sci-fi books",
        items="Inception, The Matrix, Harry Potter, Dune, Interstellar",
        n=3
    )

    async with LLMConnection() as llm:
